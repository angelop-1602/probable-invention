...
import { getFundingText, getResearchTypeText } from "./utils";
...
export const ApplicationDetails = ({ application }: ApplicationDetailsProps) => {
    ...
    const handleSaveChanges = () => {
        // In a real app, this would save changes to Firebase
        // For demo purposes, we just close the dialog
        setIsEditDialogOpen(false);
        // To implement: Update application data
    };
                ...
                <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p className="font-medium">{application.spupRecCode}</p>
                        </div>
                        <div>
