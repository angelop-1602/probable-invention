        ...
        <div>
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-medium">{application.resubmission.date || "N/A"}</p>
            </div>
            <div>
                ...
                <div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p>{application.initialReview.date}</p>
                    </div>
                    <div>
              ...
              {application.progressReport.date ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p>{application.progressReport.date}</p>
                  </div>
            ...
            <div className="space-y-4 p-4">
              ...
              {application.finalReport.date ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="text-sm font-medium text-gray-500">Submission Date</h4>
                    <p>{application.finalReport.date}</p>
                  </div>
                  <div>
                    <h4 className="text-sm font-medium text-gray-500">Status</h4>
                    <p>Submitted</p>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p>{application.archiving.date}</p>
                    </div>
                  </div>
